...
void TestableGameEngine::runInternal() {
    ...
    std::vector<Player *> *newPlayers = new std::vector<Player *> { berserk1,dummyOnHill, berserk2,ambusher1,tracer1,pacifist1, tracer2,ambusher2, ambusher3, ambusher4,pacifist2 } ;                                                                  

    GameEngine engine2 = GameEngine(newBoardSize, newPlayers);
    std::cout<<engine2[10]<<std::endl;

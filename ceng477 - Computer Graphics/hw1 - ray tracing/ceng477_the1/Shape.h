...
public:
	...
	Sphere(int id, int matIndex, int cIndex, float R, vector<Vector3f> *pVertices);	// Constructor
...
public:
	...
	Triangle(int id, int matIndex, int p1Index, int p2Index, int p3Index, vector<Vector3f> *pVertices);	// Constructor
	ReturnVal intersect(const Ray & ray) const; // Will take a ray and return a structure related to the intersection information. You will implement this. 
...
private:
	...
	int p3Index;
	vector<Vector3f> *pVertices;
	float determinant(const Vector3f &first, const Vector3f &second, const Vector3f &other) const;
};
...
public:
	...
	Mesh(int id, int matIndex, const vector<Triangle>& faces, vector<int> *pIndices, vector<Vector3f> *pVertices);	// Constructor
	ReturnVal intersect(const Ray & ray) const; // Will take a ray and return a structure related to the intersection information. You will implement this. 
